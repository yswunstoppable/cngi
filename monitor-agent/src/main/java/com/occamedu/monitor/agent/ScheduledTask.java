package com.occamedu.monitor.agent;


import cn.hutool.json.JSONArray;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.occamedu.monitor.agent.entity.*;
...
public class ScheduledTask {
    ...
    public void minTask() {
        ...
        try {
            ...
            restUtil.post(commonConfig.getServerUrl() + "/monitor-server/agent/minTask", jsonObject);
        }
    ...
    public void appInfoListTask() {
        ...
        try {
            ...
            String resultJson = restUtil.post(commonConfig.getServerUrl() + "/monitor-server/appInfo/agentList", paramsJson);
            if (resultJson != null) {
