package com.occamedu.monitor.server.task;


import cn.hutool.core.collection.CollectionUtil;
import com.occamedu.monitor.server.config.CommonConfig;
import com.occamedu.monitor.server.entity.*;
import com.occamedu.monitor.server.mapper.*;
import com.occamedu.monitor.server.service.*;
import com.occamedu.monitor.server.entity.*;
import com.occamedu.monitor.server.mapper.*;
import com.occamedu.monitor.server.service.*;
import com.occamedu.monitor.server.util.DateUtil;
import com.occamedu.monitor.server.util.RestUtil;
import com.occamedu.monitor.server.util.jdbc.ConnectionUtil;
import com.occamedu.monitor.server.util.jdbc.RDSConnection;
import com.occamedu.monitor.server.util.msg.WarnMailUtil;
import com.occamedu.monitor.server.util.msg.WarnPools;
import com.occamedu.monitor.server.util.msg.WarnSmsUtil;
import com.occamedu.monitor.server.util.staticvar.BatchData;
                ...
                for (SystemInfo systemInfo : list) {
                    ...
                    if (diff > delayTime) {
                        ...
                        Runnable runnable = () -> {
                            ...
                            WarnSmsUtil.sendHostDown(systemInfo, true);
                        };
