...
public class WarnMailUtil {
    ...
    public static boolean sendWarnInfo(MemState memState) {
        ...
        if (StaticKeys.NO_SEND_WARN.equals(warnConfig.getAllWarnMail()) || StaticKeys.NO_SEND_WARN.equals(warnConfig.getMemWarnMail())) {
            return false;
        }
    ...
    public static boolean sendHeathInfo(HeathMonitor heathMonitor, boolean isDown) {
        ...
        MailSet mailSet = StaticKeys.mailSet;
        if (StaticKeys.NO_SEND_WARN.equals(warnConfig.getAllWarnMail()) || StaticKeys.NO_SEND_WARN.equals(warnConfig.getHeathWarnMail())) {
            return false;
        }
    ...
    public static boolean sendAppDown(AppInfo appInfo, boolean isDown) {
        ...
        MailSet mailSet = StaticKeys.mailSet;
        if (StaticKeys.NO_SEND_WARN.equals(warnConfig.getAllWarnMail()) || StaticKeys.NO_SEND_WARN.equals(warnConfig.getAppDownWarnMail())) {
            return false;
        }
    ...
    public static String sendMail(String mails, String mailTitle, String mailContent) {
        try {
            ...
            email.setFrom(StaticKeys.mailSet.getFromMailName(), "occamedu监控系统");//发信者
