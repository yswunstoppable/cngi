...
public class Test {
    ...
    private Expect4j getExpect() {
        try {
            ...
            log.warning("Connect to " + ip + ":" + port + "failed,please check your username and password!");
            ex.printStackTrace();
        }
        return null;
    }
    ...
    public static void main(String[] args) {
        Test test = new Test("10.172.10.158", 22, "lorick", "lorick2009");
        test.executeCommands(new String[]{"conf", "address attack-ip", "ip 2.2.2.2/12", "exit", "exit", "exit"});
